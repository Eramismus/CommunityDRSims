...
dyn_price = 0
stat_cost = 50
flex_cost = 150 # Utilisation cost for flexibility
rho = 250 # Cost of comfort violations
...
temp_lag2 = 12 # Lag from further away for temps
...
for simtime in sim_range:
    ...
    for Sim in Sim_list:
        ...
        # Initialise the problem - get the lagged temperatures
        if i == 1:
        ...
        # Write the problem
        compr_capacity = Sim.compr_capacity
        prob, hp_power, intemp, slack_1, slack_2 = lp_enemin(Sim, opt_index, rho, compr_capacity)
        ...
        print(Sim.emu.display_measurements('Measured'))
        print(Sim.emu.display_measurements('Measured').values[1][0])
