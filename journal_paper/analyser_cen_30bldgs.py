...
for sim_id in sim_ids:
    ...
    for bldg in plot_bldgs:
        for time in mpctemps[sim_id].keys():
            ...
            #print(mpctemps[sim_id][time].index.get_level_values(0))
            #print(mpctemps[sim_id][time].index.get_level_values(1))
            #print(mpctemps[sim_id][time][time, plot_bldgs[0]+'_'+model_id])
